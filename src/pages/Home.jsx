        ...
        >
          <div className="flex lg:flex-1">
            <div className="-m-1.5 p-1.5">
              ...
              <img className="h-8 w-auto rounded" src="/logo.png" alt="" />
            </div>
          </div>
            ...
            <div className="mx-auto max-w-4xl py-32 sm:py-48 lg:py-56">
              <div className="text-center">
                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                  Discover Exceptional Educators for Your Child's Success.
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Welcome to Teacher Review System - Your Ultimate Source for
                  Detailed Teacher Insights, Rankings, and a Wealth of
                  Educational Information. Uncover the Best Educators for Your
                  Child's Success!
                </p>
