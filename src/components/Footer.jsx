    ...
    return (
        <div className="flex items-center w-full py-6 mt-6 text-white sm:mt-0 sm:px-12 bg-accent_primary font-primary justify-evenly">
            ...
            <div className="flex items-center font-medium">
                ...
                <span>
                    <a href="https://innovisionx-tech.vercel.app/" target="_blank" className="font-semibold underline cursor-pointer hover:no-underline" >InnoVisionX</a><span className="hidden sm:inline"> - All rights reserved.</span>
                </span>
            </div>
